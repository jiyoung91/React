import { Box, FormControlLabel, Checkbox, FormLabel, FormGroup, FormControl, FormHelperText  } from '@mui/material'
  ...
  return (
    <Box>
        <Box>
            ...
            control={<Checkbox size='small' color='secondary' checked={acceptTnc}
